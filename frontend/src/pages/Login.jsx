...
import { Eye, EyeOff, Github, Lock, Mail, ArrowRight, Chrome, AlertCircle } from 'lucide-react';
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: '#09090b', display: 'flex', flexDirection: 'column', color: '#fafafa' }}>
      <style>{`
        ...
        .btn-social { flex:1;display:flex;align-items:center;justify-content:center;gap:8px;background:#18181b;border:1px solid #3f3f46;border-radius:8px;padding:9px;font-size:13px;color:#a1a1aa;cursor:pointer;transition:background .15s,color .15s; }
        .btn-social:hover { background:#27272a;color:#fafafa; }
        .sep-line { flex:1;height:1px;background:#27272a; }
        .chk { width:14px;height:14px;border:1px solid #52525b;border-radius:3px;background:#18181b;cursor:pointer;appearance:none;-webkit-appearance:none;flex-shrink:0;transition:background .15s,border-color .15s; }
        .chk:checked { background:#fafafa;border-color:#fafafa; }
        .chk:checked::after { content:'✓';display:block;color:#09090b;font-size:10px;line-height:14px;text-align:center; }
      `}</style>
        ...
        <div className="ca" style={{ width:'100%',maxWidth:'320px' }}>
          ...
          <div style={{ background:'rgba(24,24,27,0.8)',border:'1px solid #27272a',borderRadius:'14px',backdropFilter:'blur(12px)',WebkitBackdropFilter:'blur(12px)',overflow:'hidden' }}>
            ...
            <div style={{ padding:'24px 24px 20px' }}>
              <h2 style={{ fontSize:'22px',fontWeight:700,color:'#fafafa',margin:'0 0 4px 0',lineHeight:1.2 }}>GroupsApp</h2>
              <p style={{ fontSize:'13px',color:'#71717a',margin:'0 0 20px 0' }}>Sign in to your account</p>
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div style={{ display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:18 }}>
                  <label style={{ display:'flex',alignItems:'center',gap:7,cursor:'pointer' }}>
                    <input type="checkbox" checked={rememberMe} onChange={e => setRememberMe(e.target.checked)} className="chk" />
                    <span style={{ fontSize:'13px',color:'#a1a1aa' }}>Remember me</span>
                  </label>
                  <a href="#" style={{ fontSize:'13px',color:'#a1a1aa',textDecoration:'none' }}
              ...
              <div style={{ display:'flex',alignItems:'center',gap:10,margin:'18px 0' }}>
                ...
                <span style={{ fontSize:'11px',color:'#52525b',textTransform:'uppercase',letterSpacing:'.08em',whiteSpace:'nowrap' }}>or</span>
                <div className="sep-line" />
              </div>
            ...
            <div style={{ padding:'14px 24px',borderTop:'1px solid #1f1f22',textAlign:'center' }}>
              <span style={{ fontSize:'13px',color:'#71717a' }}>
                ...
                <Link to="/register" style={{ color:'#a1a1aa',textDecoration:'none',fontWeight:500 }}
                  onMouseEnter={e => e.target.style.color='#fafafa'} onMouseLeave={e => e.target.style.color='#a1a1aa'}>
                  Create one
                </Link>
              </span>
